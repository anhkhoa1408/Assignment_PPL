...
class Emitter():
    ...
    *   @param isFinal true in case of constant; false otherwise
    '''
    def emitATTRIBUTE(self, lexeme, in_, isFinal, isStatic, value):
        #lexeme: String
        #in_: Type
        #isFinal: Boolean
        #value: String
    ...
    def emitPUTFIELD(self, lexeme, in_, frame):
        ...
        if frame.currOpStackSize > 1:
            frame.pop()
            frame.pop()
        # elif frame.getMaxIndex() == 1:
        #     frame.pop()
    ...
    *   @param in the type descriptor of the method.
    ...
    def emitINVOKESPECIAL(self, frame, lexeme=None, in_=None):
        ...
        # elif lexeme is not None and in_ is None:
        #     frame.pop()
        #     return self.jvm.emitINVOKESPECIAL()
    ...
    *   @param in the type of the returned expression.
    ...
    def emitRETURN(self, in_, frame):
        #in_: Type
        #frame: Frame
        if not type(in_) is VoidType and frame.currOpStackSize > 0:
            frame.pop()
